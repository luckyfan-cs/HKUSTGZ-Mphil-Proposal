...
\input{chapter/sec-research-topic}
\input{chapter/sec-literature-review}
\input{chapter/sec-main-content.tex}
\input{chapter/sec-accomplished-work}
\input{chapter/sec-research-plan}
\input{chapter/sec-required-conditions}
\input{chapter/sec-anticipated-problems.tex}
